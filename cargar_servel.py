...
def main():
    ...
    if not df.empty:
        print(f"✅ ¡Operación Exitosa! Se inyectaron correctamente bases del SERVEL a la Red Central.")
        print("👉 Abre tu centro de mando usando: streamlit run dashboard.py")
    else:
        print(f"⚠️ Algoritmo falló al procesar o el archivo subido no tenía registros válidos.")
